...
namespace Tripex.Core.Services
{
    public class FollowersService(ICrudRepository<Follower> repo) : IFollowersService
    {
        ...
        public async Task<IEnumerable<Follower>> GetFollowersAsync(Guid userId, string? userName)
        {
        ...
        public async Task<IEnumerable<Follower>> GetFollowingAsync(Guid userId, string? userName)
        {
            return await repo.GetQueryable<Follower>()
