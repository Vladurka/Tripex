...
public interface IProfilesRepository
{
    ...
    public Task<Profile?> GetProfileByIdAsync(ProfileId id, CancellationToken cancellationToken, bool asNoTracking = true);
    public Task<bool> ProfileNameExistsAsync(string userName, CancellationToken cancellationToken);
    public Task RemoveProfileAsync(ProfileId id, CancellationToken cancellationToken);
